...

{
    ...
    // Herda de FormLoader se você estiver usando a classe base, caso contrário, herde de Form
...

    {
        ...
        // Classe para guardar dados nos botões
...

        {
            ...
            // Define o painel para centralização automática (da classe base FormLoader)
...

        {
...

            {
                ...
                _cellSize = Math.Max(20, Math.Min(100, _cellSize)); // Limites
            ...
            // 2. BARRA DE EXECUÇÃO (Abaixo da Grid)
            ...
            // Barra de execução ocupa o resto da largura
            ...
            // 3. ÁREA INFERIOR (Comandos Esq, Funções Dir)
        ...
        private void HandleVictory() { gameTimer.Stop(); MessageBox.Show("Vitória!"); SetEditMode(true); this.Close(); }
...

        {
...

            {
                ...
                // Botão de limpar condição tem um X
...

        {
...

            {
                ...
                _selectedSlot.Text = GetSymbol(tag); // Mostra o símbolo no botão da função
        ...
        // --- PINTURA DA GRADE (Encostada + Arredondada) ---
...

        {
            ...
            int cornerRadius = 8; int padding = 0; // Encostado
